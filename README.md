...
**Chrome Web Store (still on 1.0.0 release - 1.4.2 currently pending, will update to 1.6.1 when 1.4.2 is approved 🤞):**  
...
**Firefox Add-Ons Store (up-to-date at 1.6.1 currently):**  
...
**Edge Add-Ons Store (still on 1.0.0 release - 1.6.1 currently pending):**  
